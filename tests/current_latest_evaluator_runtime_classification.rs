...
#[test]
fn test_39_1_2_evaluator_runtime_remains_p0_eval_runner_until_fixture_exists() {
    /* TEST-39.1.2 */
...
#[test]
fn test_39_1_4_golden_keeps_evaluator_runtime_classified_without_unclassified_diff() {
    /* TEST-39.1.4 */
    ...
    if !blockers.is_empty() {
        assert!(
            ...
            "pre-fixture evaluator runtime gap should stay an explicit Bug blocker: {blockers:#?}"
        );
