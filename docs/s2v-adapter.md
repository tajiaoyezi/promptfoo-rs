...
| 33 | current-latest-eval-deletion-burndown | docs/specs/phases/phase-33-current-latest-eval-deletion-burndown.md | Ready | 1 | N/A (solo) |
...
| 33.1 | cache-resume-store | docs/specs/tasks/task-33.1-current-latest-eval-deletion-burndown.md | Ready | Phase 33 order 1 | N/A (solo) |
