...
| 16.2 | measured-release-gate-reports | ../tasks/task-16.2-measured-release-gate-reports.md | Done | 用实际测量/派生报告替换 runtime-smoke 中的合成 performance/security/release JSON |
| 16.3 | source-extracted-inventory-real-upstream-smoke | ../tasks/task-16.3-source-extracted-inventory-real-upstream-smoke.md | In Progress | 用 source extraction 与真实 `promptfoo@0.121.13` smoke 证明矩阵和 golden runner 不是仅靠本地替身 |
