...
| 16.3 | source-extracted-inventory-real-upstream-smoke | ../tasks/task-16.3-source-extracted-inventory-real-upstream-smoke.md | Done | 用 source extraction 与真实 `promptfoo@0.121.13` smoke 证明矩阵和 golden runner 不是仅靠本地替身 |
