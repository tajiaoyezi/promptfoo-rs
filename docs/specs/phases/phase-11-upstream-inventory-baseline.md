...
|---|---|---|---|---|
| 11.1 | current-upstream-target-policy | ../tasks/task-11.1-current-upstream-target-policy.md | Done | 明确 frozen baseline 与 moving upstream 的兼容声明边界 |
| 11.2 | item-level-capability-inventory | ../tasks/task-11.2-item-level-capability-inventory.md | Done | 从 upstream 源码/docs/examples 提取 item-level 能力清单 |
| 11.3 | compatibility-matrix-expansion | ../tasks/task-11.3-compatibility-matrix-expansion.md | Done | 用 item-level inventory 扩展兼容矩阵并阻断沉默遗漏 |
