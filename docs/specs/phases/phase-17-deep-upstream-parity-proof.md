...
|---|---|---|---|---|
| 17.1 | frozen-source-inventory-extractor | ../tasks/task-17.1-frozen-source-inventory-extractor.md | Ready | 从 frozen upstream tag/package 源码提取完整 capability inventory 并阻断 silent omissions |
| 17.2 | cli-global-eval-redteam-parity | ../tasks/task-17.2-cli-global-eval-redteam-parity.md | Ready | 扩展 top-level/eval/redteam CLI command/flag parity 或明确 unsupported/later 行为 |
| 17.3 | real-p0-golden-corpus-runner | ../tasks/task-17.3-real-p0-golden-corpus-runner.md | Ready | 让至少 50 个 P0 fixture 真实执行 upstream 与 promptfoo-rs 并持久化 diff artifacts |
