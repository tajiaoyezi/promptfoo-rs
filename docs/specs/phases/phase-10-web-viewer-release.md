...
|---|---|---|---|---|
| 10.1 | web-viewer | ../tasks/task-10.1-web-viewer.md | Draft | 实现本地 viewer 读取 JSONL/SQLite 结果、筛选失败样本和导出 |
| 10.2 | release-docs-packaging | ../tasks/task-10.2-release-docs-packaging.md | Draft | 完成 GitHub Releases、Homebrew、Cargo、Docker、npm wrapper、GitHub Action 示例和贡献文档 |
...
- [ ] Phase 10 所有 task spec 顶部 Status 已从 Draft 经用户审核后推进到 Ready，再由实施 agent 完成到 Done。
