...
|---|---|---|---|---|
| 29.1 | current-latest-eval-runner-burndown | ../tasks/task-29.1-current-latest-eval-runner-burndown.md | Ready | 将 current-latest 18 个 eval-runner blockers 拆为 8 个 fixture-covered rows、3 个 P1 snapshot rows 和 7 个保留 P0 blockers |
