...
|---|---|---|---|---|
| 24.1 | current-latest-upstream-authority-lock | ../tasks/task-24.1-current-latest-upstream-authority-lock.md | Ready | 将 npm latest、GitHub HEAD、GitHub latest release 观测写成 immutable current-latest target packet |
