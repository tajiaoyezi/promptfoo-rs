...
|---|---|---|---|---|
| 19.1 | viewer-config-source-reclassification | ../tasks/task-19.1-viewer-config-source-reclassification.md | Ready | 将 `src/app/**` viewer config/editor 源文件从 generated P0 core config blocker 纠正为 P1 Local Web viewer accounting evidence |
| 19.2 | core-config-source-fixture-burndown | ../tasks/task-19.2-core-config-source-fixture-burndown.md | Ready | 为剩余 non-app core config rows 补 native/bridge fixture 或显式 blocker |
| 19.3 | provider-request-response-fixture-burndown | ../tasks/task-19.3-provider-request-response-fixture-burndown.md | Ready | 为不需要真实账号授权的 provider module blockers 补 dedicated request/response fixtures |
