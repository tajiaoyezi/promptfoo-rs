...
- [ ] **AC1** (ADR-011): Rust target-lock parsing records GitHub default branch HEAD `2ca16c59b64e0afca10533de0f817c0d24eba20a` while npm latest and GitHub latest release remain `0.121.14`.
...
- [ ] **AC3** (ADR-007 / ADR-009): runtime smoke regenerates downstream current-latest artifacts for the refreshed HEAD and leaves `current_latest_claim_allowed=false` / `perfect_refactor_claim_allowed=false` unless all gates agree.
- [ ] **AC4** (task 41.1): evaluator runtime native fixture evidence and all prior local current-latest fixture evidence survive re-extraction, or any new local blocker is surfaced explicitly by release-gate artifacts.

## 7. SDD / BDD / TDD Traceability

| Acceptance Criterion | BDD Scenario | TDD Test | Integration / E2E Test | Verification | Status |
|---|---|---|---|---|---|
| AC1 | SCEN-42.1.1 | TEST-42.1.1 | tests/current_latest_github_head_drift_refresh.rs | install, lint, typecheck, unit-test, build | Not Started |
| AC2 | SCEN-42.1.1 | TEST-42.1.2 | tests/current_latest_github_head_drift_refresh.rs | install, lint, typecheck, unit-test, integration, build | Not Started |
| AC3 | SCEN-42.1.1 | TEST-42.1.3 | tests/current_latest_github_head_drift_refresh.rs | install, typecheck, unit-test, e2e, runtime-smoke, build | Not Started |
| AC4 | SCEN-42.1.1 | TEST-42.1.4 | tests/current_latest_github_head_drift_refresh.rs | install, lint, typecheck, unit-test, coverage, runtime-smoke, build | Not Started |
